...
<header>
    ...
    <div class="sidebar" style="margin-top: -24px;">
        ...
        <form action="telaGestor_Lista.php" method="POST">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        while ($rowEmpregado = mysqli_fetch_assoc($result)) {
                            ...
                            echo  "<td>" . $rowEmpregado['codEmpresa'] . "</td>";
                            echo  "<td>" . $rowEmpregado['codCargo'] . "</td>";
                            echo  "<td>" . $rowEmpregado['descCargo'] . "</td>";
                        ...
                        $selectEmpregado = "SELECT * FROM `empregados`";
                        $result = mysqli_query($conn, $selectEmpregado);
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Nesse tela é possível ver todos os funcionários registrados em seu setor. <br><br>Você também pode procurar por um funcionário específico utilizando o código do funcionário ou seu nome.
                </div>
